...
Pezhwan (پېژوان) project and our community a harassment-free experience for
...
- Focusing on what is best not just for us as individuals, but for the overall
  community and the security of Pezhwan users
...
- Any activity that compromises the security of Pezhwan, its maintainers, or
  its users without authorization (see also [SECURITY.md](SECURITY.md))
...
```
<conduct@pezhwan.example — replace with the real contact address>
```
...
with adjustments specific to the Pezhwan project and community.