...
- [architecture/diagrams/](./architecture/diagrams/) — PlantUML diagram sources
  (system-overview, auth-flow, deployment).
- [diagrams/](./diagrams/) — rendered architecture diagrams (SVG + PNG,
  generated by [`scripts/render-diagrams.mjs`](../scripts/render-diagrams.mjs))
  with Mermaid sources listed in [diagrams/index.md](./diagrams/index.md).
